...
const TenagaMedis = () => {
  ...
  if (loading) {
    return (
      <div className="config-tenaga-medis-medis-container">
      <div className="config-tenaga-medis-medis-title-container">
        <h2 className="config-tenaga-medis-medis-title">Tenaga Medis <button className="config-tenaga-medis-settings-button" onClick={handleTenagaMedisConfig} title="Konfigurasi Waktu Pelayanan">
        ...
        <div className="config-tenaga-medis-medis-loading">
  ...
  if (error) {
    return (
      ...
      <div className="config-tenaga-medis-medis-title-container">
        ...
        <div className="config-tenaga-medis-medis-error">
          <p>{error}</p>
        </div>
      </div>
    );
  ...
  if (images.length === 0) {
    return (
      ...
      <div className="config-tenaga-medis-medis-title-container">
        ...
        <div className="config-tenaga-medis-medis-empty">
  ...
  return (
    <div className="config-tenaga-medis-medis-container">
      ...
      <div className="config-tenaga-medis-medis-carousel-wrapper">
        {/* Tombol Previous - hanya tampil jika gambar lebih dari imageCount */}
        {shouldShowNavButtons() && (
          <button 
            onClick={handlePrev} 
            className="config-tenaga-medis-medis-carousel-button left"
        ...
        <div className="config-tenaga-medis-medis-carousel">
          <div
            className={`config-tenaga-medis-medis-carousel-track ${shouldCenterImages() ? 'centered' : ''}`}
            style={{ 
          ...
          >
            {images.map((img, index) => (
              <div key={img.id || index} className="config-tenaga-medis-medis-carousel-item">
                <div className="config-tenaga-medis-medis-card">
                  <img
                    src={img.src}
                    alt={`Tenaga Medis ${img.caption}`}
                    loading="lazy"
                    className="config-tenaga-medis-medis-carousel-image"
                    onClick={() => setPopupImage(img.src)}
                    onError={(e) => {
                      e.target.src = '/assets/placeholder-avatar.png';
                    }}
                  />
                  <span className="config-tenaga-medis-medis-caption" title={img.caption}>
                    {img.caption}
                  </span>
                </div>
              </div>
        ...
        {shouldShowNavButtons() && (
          <button 
            onClick={handleNext} 
            className="config-tenaga-medis-medis-carousel-button right"
      ...
      {popupImage && (
        <div className="config-tenaga-medis-medis-popup-overlay" onClick={closePopup}>
          <div className="config-tenaga-medis-medis-popup-image-wrapper" onClick={(e) => e.stopPropagation()}>
            <button className="config-tenaga-medis-medis-close-button" onClick={closePopup}>X</button>
            <img
              src={popupImage}
              alt="Popup"
              loading="lazy"
              className="config-tenaga-medis-medis-popup-image"
