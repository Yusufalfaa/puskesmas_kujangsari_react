...
const TenagaMedis = () => {
  ...
  const handleTenagaMedisConfig = () => {
    navigate('/admin-config-tenagaMedis');
  };
  ...
  if (loading) {
    return (
      <div className="tenaga-medis-container">
        <div className="tenaga-medis-header">
          <h2 className="tenaga-medis-title">Tenaga Medis</h2>
          <button 
            className="tenaga-medis-settings-button"
            onClick={handleTenagaMedisConfig}
            title="Pengaturan Tenaga Medis"
          >
            ⚙️
          </button>
        </div>
  ...
  if (error) {
    return (
      <div className="tenaga-medis-container">
        <div className="tenaga-medis-header">
          <h2 className="tenaga-medis-title">Tenaga Medis</h2>
          <button className="tenaga-medis-settings-button" onClick={handleTenagaMedisConfig} title="Konfigurasi Waktu Pelayanan">
