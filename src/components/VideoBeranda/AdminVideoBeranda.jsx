...
const VideoBeranda = () => {
  ...
  const handleSettingsConfig = () => {
    navigate('/admin-config-videoBeranda');
  };
  ...
  return (
    <div className="video-placeholder-container">
      <div className="video-header">
        <button className="settings-btn-videoBeranda" onClick={handleSettingsConfig} title="Konfigurasi Petugas Kesehatan">
