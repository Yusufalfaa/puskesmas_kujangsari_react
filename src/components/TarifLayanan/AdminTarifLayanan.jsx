...
const TarifPelayanan = () => {
  ...
  const handleTarifPelayananConfig = () => {
    navigate('/admin-config-tarifPelayanan');
  };
  ...
  if (loading) {
    return (
      <div className="tarif-container">
        <h2 className="tarif-title">Tarif Pelayanan <button className="config-tenaga-medis-settings-button" onClick={handleTarifPelayananConfig} title="Konfigurasi Waktu Pelayanan">
